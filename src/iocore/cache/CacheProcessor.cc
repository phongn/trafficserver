...
CacheProcessor::cacheInitialized()
{
  ...
  if (caches_ready) {
    ...
    if (gnstripes) {
      ...
      static const char *const ram_cache_algorithm_name[] = {"CLFUS", "LRU", "W-TinyLFU", "SIEVE", "S3-FIFO"};
      ...
      for (int i = 0; i < gnstripes; i++) {
        ...
        case RAM_CACHE_ALGORITHM_WTINYLFU:
          ...
          break;
        case RAM_CACHE_ALGORITHM_SIEVE:
          gstripes[i]->ram_cache = new_RamCacheSieve();
          break;
